...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'car', 'lme4', 'mediation', 'ggplot2', 'afex', 'lmerTest', 'BayesFactor', 'GGally', 'codingMatrices', 'emmeans', 'effectsize', 'tidyr', 'forcats', "HDInterval", "lavaan", "sem", "OpenMx", "semPlot", "brms", "bridgesampling"
), 'packages.bib')
```
