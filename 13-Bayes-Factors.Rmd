...
mod_priors_alt <- c(# intercept
                ...
                prior(normal(0, 2), class = b, coef = "percent_bachelors_degree_or_higher"),
                # error SD
                prior(normal(0, 2), class = sigma))
