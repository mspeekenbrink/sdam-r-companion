...
We will only cover the most very basics of Exploratory Factor Analysis (EFA) here. In EFA, all "factors" (which are the latent variables in the model), are related to all observed variables (sometimes also called the "manifest" variables). 
