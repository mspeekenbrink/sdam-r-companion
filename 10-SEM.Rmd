...
speed_mod3_spec <- '
  ...
  date_like ~~ 0*other_like
'
speed_mod3 <- lavaan::sem(speed_mod3_spec, data=speeddate)
```


```{r}
semPlot::semPaths(speed_mod3, layout="tree2", sizeMan=7, residuals=TRUE, rotation=1, intAtSide = FALSE, whatLabels = "est", nCharNodes = 12, normalize=TRUE, width=12, height=6)
```