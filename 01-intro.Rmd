...
A __list__ is a collection of different R objects. This is a very general type of object, and the elements of a list can even by lists themselves. A list allows you to keep different types of information together, but you probably won't need to use it much for the content discussed here. But let's quickly look at some aspects of a list:
```{r}
...
```{r}
IQR(fifa2010teams$goals_for,type=4)
```
