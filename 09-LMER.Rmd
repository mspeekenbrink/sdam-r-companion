...
Table: (\#tab:lmer-fixed-effects-formula-examples) Examples of R's formula notation for fixed effects.
...
Table: (\#tab:lmer-fixed-effects-formula-examples) Examples of lme4's formula notation for random effects.
